# GeoIcons Commercial License Agreement

**Version 1.0**
Copyright © 2026 GeoIcons · https://geoicons.io

---

## 1. Background & Dual-License Summary
...
License at **https://geoicons.io** before using GeoIcons.
...
## 3. Acceptance & Effective Date

This agreement becomes effective on the date the Licensee purchases a tier (the
"Effective Date"). By purchasing a tier, installing the Software under a commercial
License Key, or otherwise using the Software outside the GPLv3 terms, the Licensee
accepts and agrees to be bound by this agreement. The purchase receipt issued by
Lemon Squeezy (the Merchant of Record, see §9) and the associated License Key
together identify the Licensee and the purchased Tier.

---

## 4. Grant of License

Upon purchase of the applicable tier, the Licensor grants the Licensee a
**non-exclusive, non-transferable, worldwide license** to:

- Install, use, and integrate the GeoIcons icon set and its components into
  the Licensee's applications.
- Distribute the icons **as part of a compiled Product** (end-user delivery),
  but **not** as a standalone redistributable icon set (except under the **Extended**
  tier, see §5).
...
- Unlimited developers
- 1 product
- Use in commercial apps + redistribution (SDKs, themes, builders)
- Priority email support
- Free updates as the catalog grows
...
## 8. Attribution (Optional but Appreciated)

Attribution is not required. If you choose to credit GeoIcons, the preferred form is:

> "Map icons by [GeoIcons](https://geoicons.io)"

---

## 9. Payment & Taxes

- Payments are processed by **Lemon Squeezy**, acting as **Merchant of Record (MoR)**.
  Lemon Squeezy collects and remits applicable sales tax/VAT and issues the receipt
  of record.
- Annual billing options are recurring charges managed by Lemon Squeezy; the
  Licensee may cancel renewal at any time, which stops future charges without
  revoking versions already obtained (see §6).
...
- Is found to have used this license to cover a scope beyond the purchased tier.

Upon termination, the Licensee must cease all use and distribution of GeoIcons in
new deployments (existing deployed applications may continue operating under a
reasonable wind-down period of 90 days).

---

## 13. Governing Law

This agreement is governed by the laws of the jurisdiction in which the Licensor
...
The Licensor may update this agreement from time to time. The version that applies to
a given purchase is the version in effect on that purchase's Effective Date. Updated
terms apply to subsequent purchases and to the relationship going forward, but do not
retroactively revoke the permanent rights already granted for a completed purchase
(§4, §6). The current version is always published at https://geoicons.io.

---

## 15. Entire Agreement

This document, together with the purchase receipt issued by Lemon Squeezy
(Merchant of Record), constitutes the entire agreement between the parties
regarding the subject matter herein and supersedes all prior communications.

---

*For licensing questions: https://geoicons.io · For open-source use, see [`LICENSE`](./LICENSE)*
